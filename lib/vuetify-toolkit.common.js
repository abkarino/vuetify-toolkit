...
var BaseSlideGroup = mixins(BaseItemGroup, mobile).extend({
  ...
  methods: {
    ...
    setWidths
    /* istanbul ignore next */: function setWidths() {
      var _this4 = this;
      window.requestAnimationFrame(function () {
...
/******/ });
//# sourceMappingURL=vuetify-toolkit.common.js.map